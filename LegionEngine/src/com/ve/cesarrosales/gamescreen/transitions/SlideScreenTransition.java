...
public class SlideScreenTransition implements ScreenTransition {
	...
	private static final SlideScreenTransition instance = new SlideScreenTransition();
	private float duration;
	TransitionDirection direction;
	boolean slideOut;
	Interpolation easing;

	public static SlideScreenTransition init(float duration,
			TransitionDirection direction, boolean slideOut,
			Interpolation easing) {
