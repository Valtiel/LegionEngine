...
public class RenderSystem implements SubSystem, Resizable{
	...
	public void update(float delta) {
		...
		batch.begin();
		//Gdx.gl.glClearColor(0.243137255f,0.262745098f,0.411764706f,1);
	...
	public void init() {
        ...
        space = new Sprite(new Texture(pixmap));  
        space.setPosition(-427, -300);  
        space.setSize(854, 600);  
        space.setColor(0.243137255f,0.262745098f,0.411764706f,1f);
