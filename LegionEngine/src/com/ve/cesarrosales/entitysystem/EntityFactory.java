...
import com.ve.cesarrosales.entitysystem.component.PlayerData;
...
public class EntityFactory {
	...
	public void createRandomStandardEnemy(EntityManager manager) {
		...
		manager.addComponent(entity, new SpriteComponent(
				Assets.instance.stEnemy.sprite));
